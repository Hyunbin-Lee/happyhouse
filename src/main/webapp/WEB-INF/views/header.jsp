...
<html>
  <head>
    ...
    <link rel="stylesheet" href="/css/mine.css" />
        <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=e9620381df0a5f019b155d5b376af607&libraries=services"></script>
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="/"> <img class="nav-img"src="/img/logo.png" alt="logo"> </a>
                        ...
                        <div class="collapse navbar-collapse main-menu-item" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="${root}/board/list">공지사항</a>
                                </li>
                              
                                <li class="nav-item">
                                    <a class="nav-link" href="${root}/confirmation">실거래가조회</a>
                                </li>
 ...
 <c:when test="${!empty memberInfo}">
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown_2">
                                        ...
                                        <a class="dropdown-item" href="${root}/user/memberInfo">마이페이지</a>
